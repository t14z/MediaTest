...
public class DecodeEditEncodeTest {
    ...
    private int mTrackIndex1;
    private int mTrackIndex2;

    public DecodeEditEncodeTest(Activity activity) {
    ...
    private void videoEditTest() {
        ...
        /*if (DEBUG_SAVE_FILE) {
            ...
            String fileName = "z_vedit1_" + mWidth + "x" + mHeight + ".mp4";
        ...
        /*if (DEBUG_SAVE_FILE) {
            String dirName = Environment.getExternalStorageDirectory().getAbsolutePath();
            String fileName = "z_vedit2_" + mWidth + "x" + mHeight + ".mp4";
    ...
    private void generateVideoData(MediaCodec encoder, InputSurface inputSurface,
                                   VideoChunks output) throws Exception{
        ...
        while (!outputDone) {
            ...
            while (true) {
                ...
                if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    mMuxer1 = new MediaMuxer(Environment.getExternalStorageDirectory()+"/z_fuck1.mp4", MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
                    mTrackIndex1 = mMuxer1.addTrack(newFormat);
                    mMuxer1.start();
                    ...
                    if (info.size != 0) {
                        ...
                        mMuxer1.writeSampleData(mTrackIndex1, encodedData, info);
                    }
     ...
     * @throws Exception
     */
    private void editVideoData(VideoChunks inputData, MediaCodec decoder, OutputSurface outputSurface,
                               InputSurface inputSurface, MediaCodec encoder, VideoChunks outputData)
            throws Exception{
        final int TIMEOUT_USEC = 10000;
        ...
        while (!outputDone) {
            ...
            while (decoderOutputAvailable || encoderOutputAvailable) {
                ...
                if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    mMuxer2 = new MediaMuxer(Environment.getExternalStorageDirectory()+"/z_fuck2.mp4", MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
                    mTrackIndex2 = mMuxer2.addTrack(newFormat);
                    mMuxer2.start();
                    ...
                    if (info.size != 0) {
                        ...
                        outputCount++;
                        mMuxer2.writeSampleData(mTrackIndex2, encodedData, info);
    ...
    private void checkVideoFile(VideoChunks inputData) {
        ...
        try {
            ...
            if (badFrames != 0) {
                Log.i(TAG, "Found " + badFrames + " bad frames");
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
