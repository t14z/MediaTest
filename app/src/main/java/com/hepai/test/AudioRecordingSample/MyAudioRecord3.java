...
public class MyAudioRecord3 {
    ...
    public void startRecording() {
        try {
            /** MediaMuxer init **/
            mOutputPath = Environment.getExternalStorageDirectory() + "/z_z_z.mp4";
                            ...
                            try {
                                ...
                                for (; mIsCapturing && !mRequestStop && !mIsEOS; ) {
                                    ...
                                    if (readBytes > 0) {
                                        ...
                                        inputBuffer.clear();
                                        inputBuffer.put(buf);
                                        mMediaCodec.queueInputBuffer(inputBufferIndex, 0, readBytes, getPTSUs(), 0);
        ...
        while (mIsCapturing) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (!Muxer_start()) {
                    ...
                    synchronized (MyAudioRecord3.this) {
                        while (!mIsStarted)
                            try {
                                MyAudioRecord3.this.wait(100);
