...
public class LessonOneRenderer1 implements GLSurfaceView.Renderer {
    ...
    public LessonOneRenderer1(final Context context) {
        mContext = context;
    ...
    public void onDrawFrame(GL10 gl) {  // TODO Auto-generated method stub
        ...
        for (int i = 0; i < /*mCubePositions.length*/1; i++) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTextureDataHandle[0] = ToolsUtil.loadTexture(mContext, R.drawable.ll);
